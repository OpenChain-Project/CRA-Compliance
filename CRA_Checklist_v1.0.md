...
**Tag note:** Labels such as \[CONFORMITY EVIDENCE / IMPLEMENTATION CONTROL\], \[LEGAL REVIEW / IMPLEMENTATION CONTROL\], and \[GOOD PRACTICE / IMPLEMENTATION CONTROL\] identify implementation controls that may support CRA conformity evidence but are not presented as standalone statutory obligations unless also marked \[CRA REQUIREMENT\] or \[DIRECT CRA OBLIGATION\].
...
| **4.2.5** | \[GOOD PRACTICE\] A Safety Relevance classification should be applied to components where functional safety or AI/autonomous system context applies (e.g., SRAP/SRIL safety-relevance metadata, SRACs where functional-safety application conditions apply, or equivalent). Organizations without safety-critical products may mark this item N/A with documented rationale. | ☐ Yes   ☐ No   ☐ Partial |   | Safety relevance scoring methodology; component classification register; documented rationale for using SRAP/SRIL metadata, SRACs, or equivalent classification method. |
...
| Ref | Requirement | Conformant? (Yes / No / Partial) | Evidence & Rationale | Guidance / Reference |
| :---- | :---- | :---- | :---- | :---- |
| **4.4.1** | \[CRA REQUIREMENT\] The organization must maintain a security advisory and affected-user notification process for CRA Art. 14(8), including notification criteria, channels, responsible roles, approval steps, and required content for actively exploited vulnerabilities or severe security incidents. | ☐ Yes   ☐ No   ☐ Partial |   | Advisory process; notification criteria; approval workflow; distribution channel list (CVE.org, product portal, mailing list). |
...
| **4.4.6** | \[CRA REQUIREMENT\] When CRA Art. 14(8) user notification is required, affected customers and users must be notified without undue delay regarding actively exploited vulnerabilities or severe security incidents, including available mitigations and corrective actions, and the notification execution must be recorded. | ☐ Yes   ☐ No   ☐ Partial |   | Customer advisory record; notification execution log; mailing list, portal, or security advisory feed evidence; record of mitigations and corrective actions communicated. |
...
| **4.4.10** | \[CRA REQUIREMENT\] The organization must document that the micro and small enterprise fine exemption under CRA Art. 64(10) covers only the financial penalty for missing the 24-hour Early Warning deadlines in CRA Art. 14(2)(a) and Art. 14(4)(a), and does NOT exempt the organization from the reporting obligation itself or from the 72-hour notification or final report obligations. | ☐ Yes   ☐ No   ☐ Partial |   | Written acknowledgement in compliance program documentation; Art. 14 RACI maintained regardless of micro or small enterprise status. |
