...
| RC1 / 19 Aug 2026 | Release candidate created from PA5 for final review; added cybersecurity risk assessment (§2.6), third-party software supply chain qualification, self-maintained open source software management, SBOM depth/file-snippet guidance, and strengthened secure development framing. Contributors expanded to 19. Total items: 182. | Devashri Datta |
