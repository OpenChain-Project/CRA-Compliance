...
| Protection of confidentiality of data | Part I(2)(e) | 3.4.3 | Encryption policy; data classification map; TLS 1.2+ configuration evidence |
| Protection of integrity of data, commands, programs and configuration | Part I(2)(f) | Partial \- 3.4.3, 3.3.2 | Encryption policy; TLS 1.2+ configuration evidence; artifact manifest with hash values; partial checklist gap: 3.3.2 covers integrity of release artifacts, with no dedicated control for integrity of commands, programs and configuration in the running product |
