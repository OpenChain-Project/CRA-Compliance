...
| PA2 / Jul 25, 2026 | Added §2.4.5 Internal Audit, §2.4 Exception Management (§2.4.6-2.4.8), §3.4.9 Threat Modeling, §5.1.5 Dependency Approval Gate, §7.1.6 MSA Workflow, §9.1.5 Supplier Risk Tiering, Appendix B Glossary; §3.3.5-3.3.6 Secure Build; Appendix A Annex I Traceability Matrix; Patch SLA §4.1.4; Security Contact §4.4.7 expanded. Total items: 135. | Devashri Datta |
| PA3 / Jul 25, 2026 | Added §2.5.8 Classification Decision Tree, §3.1.7 HBOM, §3.4.10 Release Gate, §3.4.11 Secure Coding Standard, §4.1.8 Vuln Metrics, §6.1.6-6.1.7 EOL Transition, §7.2.5 Telemetry Validation, §7.3 DoC workflow expanded, §7.4.5 AR operational procedures; crypto agility added to §3.4.3; independent assessment cadence to §3.4.7; §4.5 deadline markup corrected; §2.5 scope language corrected. Total items: 155. | Devashri Datta |
...
Standard operating procedures for publicly disclosing fixes, providing mitigation guidance, and meeting the three-stage CRA Article 14 regulatory reporting cascade: Early Warning (24h), Full Notification (72h), and Final Report (14 days). Items marked ⚠ are required before September 11, 2026\.
...
CRA Article 14 imposes hard time-based obligations that require pre-assigned, tested role ownership. This section ensures a named individual is accountable for each stage of the reporting cascade before the deadline. All items in this section must be completed before September 11, 2026\.

 

| Ref | Requirement | Guidance / Evidence Expected | Conformant? (Yes / No / Partial) |
| :---- | :---- | :---- | :---- |
| 4.5.1 | ⚠ DEADLINE Sep 11, 2026  A named individual (by role) is designated as the Art. 14 Notification Owner responsible for initiating the Early Warning submission to EUVDB within the 24-hour clock. Given the 24-hour legal obligation operates continuously, at minimum two trained alternates must be designated (Primary, Backup, Secondary Backup or equivalent), all trained on EUVDB submission mechanics. On-call coverage must be documented for all hours including weekends and public holidays. | RACI table entry with Primary, Backup, and Secondary Backup named by role; training completion records for all three; on-call schedule showing continuous coverage. | ☐  Yes ☐  No ☐  Partial |
| 4.5.2 | ⚠ DEADLINE Sep 11, 2026  A named individual (by role) is responsible for completing and submitting the 72-hour Full Notification to EUVDB, and is empowered to escalate to legal/executive if additional approvals are required. | RACI table entry; escalation path documented. | ☐  Yes ☐  No ☐  Partial |
| 4.5.3 | ⚠ DEADLINE Sep 11, 2026  A named individual (by role) owns the 14-day Final Report, coordinates post-incident review inputs, and signs off on the submission. | RACI table entry; final report review workflow. | ☐  Yes ☐  No ☐  Partial |
| 4.5.4 | ⚠ DEADLINE Sep 11, 2026  The organization has verified EUVDB account access, submission credentials, and at least one test submission prior to September 11, 2026\. | EUVDB account registration confirmation; test submission record or screenshot. | ☐  Yes ☐  No ☐  Partial |
| 4.5.5 | ⚠ DEADLINE Sep 11, 2026  The Art. 14 RACI is reviewed and re-confirmed upon any relevant personnel change and at minimum annually. Initial RACI must be established and reviewed before the September 11 deadline. | RACI version history; review record. | ☐  Yes ☐  No ☐  Partial |
| 4.5.6 | ⚠ DEADLINE Sep 11, 2026  The organization conducts at least one tabletop exercise validating the 24-hour, 72-hour, and 14-day Final Report notification process end-to-end, including escalation paths and EUVDB submission mechanics, prior to the September 11 deadline. The exercise is repeated annually thereafter. | Exercise records; scenario description; lessons-learned report; follow-up action log. | ☐  Yes ☐  No ☐  Partial |
