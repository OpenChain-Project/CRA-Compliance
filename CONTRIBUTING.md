...
> [!IMPORTANT]  
>The Google Doc will be deprecated in this phase!
...
For RC2 and at the conclusion of the public comment period the issues collected will be addressed by the Study Group via the scheduled calls or via the mailing list.
...
```
### Milestones
- [Release Candidate 1 (RC1)](https://github.com/OpenChain-Project/CRA-Compliance/milestone/1)
- [Release Candidate 2 (RC2)](https://github.com/OpenChain-Project/CRA-Compliance/milestone/2)
- [Version 1.0](https://github.com/OpenChain-Project/CRA-Compliance/milestone/3)
