...
| **3.1.6** | \[CRA REQUIREMENT\] Each SBOM must include product-level metadata (product name, version, supplier, release date, unique product identifier) and component-level metadata (component name, version, supplier, unique component identifier such as PURL or CPE, cryptographic hash, and license information including declared and concluded license) for each component. License information is also included in the CISA 2026 Minimum Elements for SBOM, in addition to aligning with ISO/IEC 18974 and ISO/IEC 5230 obligations. | ☐ Yes   ☐ No   ☐ Partial |   | SBOM field mapping to CRA Annex I (primary requirement), CISA 2026 Minimum Elements for SBOM (informational reference replacing the 2021 NTIA minimum elements), and BSI TR-03183-2 (implementation guidance for German market). Where these references differ, CRA Annex I takes precedence. Reference: https://www.[bsi.bund.de](https://www.bsi.bund.de/EN/Themen/Unternehmen-und-Organisationen/Standards-und-Zertifizierung/Technische-Richtlinien/TR-nach-Thema-sortiert/tr03183/TR-03183_node.html)/TR03183 |
...
| SBOM documentation (covering at least top-level dependencies) | Part II, §6 | 3.1, 3.2 | Machine-readable SBOM; CISA 2026 minimum-element field coverage; license information fields (CISA 2026; ISO/IEC 18974/5230) |
...
●  SPDX Hardware profile (SPDX 3.x) \- [spdx.dev](https://spdx.dev/learn/areas-of-interest/hardware/)

●  CycloneDX Specification 1.7 / ECMA-424 \- [cyclonedx.org](https://cyclonedx.org/specification) / [ecma-international.org](https://ecma-international.org/publications-and-standards/standards/ecma-424/)

●  CycloneDX HBOM guidance \- [cyclonedx.org](https://cyclonedx.org/capabilities/hbom/)

●  CISA 2026 Minimum Elements for a Software Bill of Materials (SBOM) (informational reference replacing the 2021 NTIA minimum elements) \- [cisa.gov](https://www.cisa.gov/resources-tools/resources/2026-minimum-elements-software-bill-materials-sbom)
