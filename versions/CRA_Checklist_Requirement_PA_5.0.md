...
| PA3 / Jul 29, 2026 | Full normative rewrite (SHALL/SHOULD/MAY); all Bitsea and Daniel Thompson-Yvetot corrections; §8.5 eIDAS; Annex D Adopters. Total items: 156\. | Devashri Datta |
...
| Ref | Requirement | Conformant? (Yes / No / Partial) | Evidence & Rationale | Guidance / Reference |
| :---- | :---- | :---- | :---- | :---- |
| **7.2.1** | \[CRA REQUIREMENT\] The SBOM SHALL be made available to market surveillance authorities upon reasoned request as part of the Technical File (CRA Annex VII). \[GOOD PRACTICE\] SBOMs MAY be made available to customers and integrators alongside each product release; this is strongly recommended practice but is not a CRA legal obligation enforceable against the manufacturer. | ☐ Yes   ☐ No   ☐ Partial |   | SBOM delivery mechanism (portal, API, package metadata, attestation) where voluntarily provided; MSA Technical File access procedure. |
