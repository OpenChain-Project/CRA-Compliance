...
| PA3 / Jul 29, 2026 | Full normative rewrite (SHALL/SHOULD/MAY); all Bitsea and Daniel Thompson-Yvetot technical corrections; §8.5 CRA and eIDAS added; Annex D Adopters added. Total items: 156\. | Devashri Datta |
| PA4 / Jul 31, 2026 | All community feedback incorporated: CRA Art. 3 role definitions; §2.1 policy corrections (Recital 76, Annex I Part II(5)); §2.5 Art. 32(5) FOSS pathway added as new item 2.5.9; IR 2025/2392 and Annex VIII Part 1 referenced; substantial modification terminology corrected; §2.6.3 corrected per EC FAQ 6.1; §3.1.1 SBOM wording corrected to CRA original text; §3.1.5 GOOD PRACTICE label and actively exploited CVE; full contributor table added. Total items: 157\. | Devashri Datta |
...
| :---- | :---- | :---- | :---- | :---- |
| **Devashri Datta (Chairman)** | devashri.datta@gmail.com |   | devashridatta-dotcom | Document author; all versions PA1-PA4 |
...
| **Andreas Kotulla** | \[confirm\] | Bitsea GmbH | \[confirm\] | SBOM format; 72h clock; Art.14(8); BSI TR-03183; SRP; VEX/CSAF |
| **Maarten Aertsen** | \[confirm\] | NLnet Labs | maertsen | Steward applicability; Art.32(5); role-neutral language; §3.5 Art.24; §5.1.6; §7.3 |
| **Madalin Neag** | \[confirm\] | OpenSSF / Linux Foundation Europe | \[confirm\] | PT1/PT3 links; C(2026) 5252; Art.32(5) FOSS; IR 2025/2392; Annex VIII Part 1; §2.1 corrections |
...
| **Marcel Kurzmann** | \[confirm\] | \[confirm\] | \[confirm\] | Evidence & Rationale column; hyperlinks in Guidance column and References |
| **Ryan Tao** | taoye@grandall.com.cn | Grandall Law Firm | AttorneyTao | §3.1.1 SBOM wording; §3.1.5 actively exploited CVE correction |
| **Mary (Meixia) Wang** | \[confirm\] | Linux Foundation | \[confirm\] |   |

 

To add your name as a contributor, contact the working group lead.
...
●  OSS Steward (Art. 3(14)): a legal person, other than a manufacturer, who provides support on a sustained basis for the development of products qualifying as FOSS and ensures the viability of those products.
...
Note on OSS Steward column: "Optional" indicates the section is not typically required by CRA Annex II steward obligations but may be adopted voluntarily. "Recommended" indicates good practice supporting steward obligations indirectly. OSS Stewards are not subject to Annex I essential requirements but must maintain a security policy and vulnerability handling process (CRA Annex II). Note: under Art. 24, stewards may also fall within scope of §3.5 importer/distributor obligations depending on their activities.
...
| **2.5** | Product Risk Categorization (incl. Art. 32(5) FOSS) | No | Yes \- Dec 11, 2027 | No \- CRA-specific; no 18974 equivalent |
| **2.6** | Harmonized Standards Tracking | No | Yes \- Dec 11, 2027 | No \- CRA-specific regulatory requirement |
| **3.1** | SBOM Generation | Partial \- §3.1.5 SBOM depth tied to 24h window | Yes \- Dec 11, 2027 | Yes \- §3.2.1-3.2.3 SBOM process and tooling |
| **3.2** | SBOM Data Quality | No | Yes \- Dec 11, 2027 | Yes \- §3.2.2 SBOM completeness |
| **3.3** | Provenance & Integrity | No | Yes \- Dec 11, 2027 | Yes \- §3.2.3 SBOM provenance |
...
| **4.1** | Vulnerability Ingestion & Monitoring | Yes \- EUVD/KEV feeds required to detect exploited vulnerabilities | No | Yes \- §3.3.1 vulnerability identification |
| **4.2** | Risk Adjudication & Vulnerability Exchange | Yes \- exploitability output informs Art. 14 decisions | No | Yes \- §3.3.2 vulnerability response |
| **4.3** | Actionable Decisions | Yes \- remediation decisions trigger Art. 14 reporting clock | No | Yes \- §3.3.2 vulnerability remediation |
...
| **4.5** | Art. 14 Notification RACI | **YES \- all items subject to Sep 11, 2026 deadline** | No | No \- CRA Art. 14 regulatory obligation; not in 18974 |
| **5.1** | OSS Contribution & Engagement | No | Yes \- Dec 11, 2027 | Partial \- §3.1.1 OSS security policy |
| **5.2** | Steward vs. Maintainer Boundaries | No | Yes \- Dec 11, 2027 | No \- CRA Steward concept not in 18974 |
| **6.1** | Support Period & Update Obligations | No | Yes \- Dec 11, 2027 | Partial \- §3.3.2 covers patching; 5-year period not in 18974 |
| **7.1** | Market Surveillance Deliverables | No | Yes \- Dec 11, 2027 | Partial \- §3.5.1 conformance documentation |
| **7.2** | Downstream Customer Provisioning | No | Yes \- Dec 11, 2027 | Partial \- §3.2.1 SBOM process |
| **7.3** | EU DoC & CE Marking | No | Yes \- Dec 11, 2027 | Partial \- §3.5.1 conformance documentation |
| **7.4** | EU Authorized Representative | No | Yes \- Dec 11, 2027 if non-EU | No \- CRA-specific legal requirement |
| **8.1** | CRA and NIS2 | Partial \- NIS2 incident reporting aligns with Art. 14 | No | No \- regulatory mapping not in 18974 |
| **8.2** | CRA and AI Act | No | Yes \- Dec 11, 2027 | No \- regulatory mapping not in 18974 |
| **8.3** | CRA and DORA | No | No | No \- regulatory mapping not in 18974 |
| **8.4** | CRA and Data Act | No | No | No \- regulatory mapping not in 18974 |
| **8.5** | CRA and eIDAS | No | No | No \- regulatory mapping not in 18974 |
| **9.1** | Vendor CRA Qualification | Partial \- §9.1.4 supplier Sep 2026 monitoring check | No | No \- procurement not in 18974 |
...
A documented cybersecurity policy for CRA compliance defines the organization's commitment and obligations. Note: §2.1 is targeted primarily at Manufacturers. The policy obligations for OSS Stewards are lighter and governed by CRA Annex II.

 

| Ref | Requirement | Conformant? (Yes / No / Partial) | Evidence & Rationale | Guidance / Reference |
| :---- | :---- | :---- | :---- | :---- |
| **2.1.1** | \[CRA REQUIREMENT\] The organization SHALL maintain a documented cybersecurity policy for CRA compliance. The policy SHOULD be formally approved by senior management or an equivalent governing body. | ☐ Yes   ☐ No   ☐ Partial |   | Policy document; approval signature or board/exec minute. |
...
| **2.1.3** | \[CRA REQUIREMENT\] The policy SHALL explicitly reference the organization's obligations under CRA Articles 13, 14, and 15 and Annex I Part II(5), which requires a policy on coordinated vulnerability disclosure. This is further detailed in Art. 13(8). PT3 additionally recommends a standalone vulnerability handling policy. | ☐ Yes   ☐ No   ☐ Partial |   | Policy text mapped to CRA articles. |
| **2.1.4** | \[CRA REQUIREMENT\] The policy SHALL cover the full product lifecycle: design, development, release, maintenance, and end-of-support, consistent with the product lifetime obligations in CRA Art. 13(2) and the vulnerability handling obligations in Art. 13(6). | ☐ Yes   ☐ No   ☐ Partial |   | Lifecycle phase coverage section in policy. |
...
| Ref | Requirement | Conformant? (Yes / No / Partial) | Evidence & Rationale | Guidance / Reference |
| :---- | :---- | :---- | :---- | :---- |
| **2.2.1** | \[CRA REQUIREMENT\] The organization SHALL designate a named individual or function with documented authority over CRA compliance program decisions. | ☐ Yes   ☐ No   ☐ Partial |   | RACI chart or org chart with role highlighted. |
...
| **2.5.9** | \[CRA REQUIREMENT\] For manufacturers of products qualifying as Free and Open Source Software (FOSS) under the commercial-activity test (§5.1.5), Art. 32(5) provides a specific conformity pathway. The organization SHALL determine whether this pathway applies and document the determination with legal rationale. Where it applies, the organization SHALL fulfill the applicable obligations under Art. 32(5) in lieu of the standard Module A or Notified Body routes. | ☐ Yes   ☐ No   ☐ Partial |   | Legal determination memo on Art. 32(5) applicability; reference to Commission guidance C(2026) 5252 on commercial-activity test criteria. |

 

## **2.6 Harmonized Standards Tracking**

CRA conformity depends on harmonized standards under Standardisation Request M/606, developed by ETSI, CEN, and CENELEC. As of July 2026, PT1 and PT3 drafts have been updated significantly since their public inquiry versions; final versions are not yet publicly available but are expected imminently. PT1 public inquiry draft and PT3 public inquiry draft are accessible via the NBN portal. ISO 27001 and IEC 62443 do not automatically create a presumption of CRA Annex I conformity, though they may be used as supporting evidence per EC FAQ 6.1 and Annex VIII Part 1\. References to Commission draft guidance have been updated to the final published version: C(2026) 5252, published July 27, 2026 (digital-strategy.ec.europa.eu/en/library/commission-publishes-new-guidance-support-timely-cyber-resilience-act-implementation).
...
CRA Recital 18 and Article 17 create a distinct compliance category for Open Source Software Stewards. This section governs upstream engagement, license compliance, and steward vs. maintainer boundaries.
...
| **5.1.2** | \[CRA REQUIREMENT\] Security vulnerabilities discovered during product work SHALL be responsibly disclosed to upstream maintainers before public disclosure (CRA Art. 13 manufacturer responsibility for third-party components). | ☐ Yes   ☐ No   ☐ Partial |   | Upstream disclosure procedure; example disclosure record. |
...
| **5.1.6** | \[CRA REQUIREMENT\] The organization SHALL maintain a documented process for managing integration risk from upstream OSS components whose maintainers are not directly CRA-obligated. This process SHALL cover how the organization assesses component security hygiene, monitors for vulnerabilities in those components, and documents its findings. Where upstream projects provide SBOM artifacts, CVD policies, or patch timelines, the organization SHOULD use them. Where they do not, the organization SHALL document its compensating measures. The organization SHOULD support upstream projects in improving security transparency over time rather than treating the absence of these artifacts as a blocker. | ☐ Yes   ☐ No   ☐ Partial |   | Upstream due-diligence checklist; criteria for accepting or rejecting components; reference to CRA Art. 13 manufacturer responsibility. |
...
Guidelines clarifying the distinct obligations of OSS Stewards \- entities providing OSS for integration into products placed on the EU market (CRA Art. 3(14)) \- versus individual project maintainers.
...
## **7.3 User-Facing Documentation (CRA Art. 24 / Annex II)**

CRA Art. 24 and Annex II require manufacturers to provide clear and understandable information and instructions to users.

 

| Ref | Requirement | Conformant? (Yes / No / Partial) | Evidence & Rationale | Guidance / Reference |
| :---- | :---- | :---- | :---- | :---- |
| **7.3.1** | \[CRA REQUIREMENT\] The organization SHALL provide information and instructions to users in a language easily understood by them, covering: intended use, cybersecurity properties, how to configure security settings, the declared end-of-support date, and how to report vulnerabilities (CRA Art. 24 / Annex II). | ☐ Yes   ☐ No   ☐ Partial |   | EU DoC template completed per Annex V; legal review sign-off. |
...
| :---- | :---- | :---- | :---- |
| **PRIORITY \- Art. 14 RACI (§4.4-4.5)** | Register SRP account; assign named owners for 24h/72h/14-day notification stages; document severe security incident definition; complete at least one test submission through the CRA Single Reporting Platform before the deadline. |   | **Before Sep 11, 2026 \- IMMEDIATE** |
| **1 \- Scope & Categorization** | Determine organizational role using §1 applicability table; confirm PDE vs SaaS (§2.5.1); complete EU establishment determination (§2.5.2/§7.4); complete risk classification including Art. 32(5) FOSS determination (§2.5.3-2.5.9). | Legal \+ CISO | Month 1-2 |
...
| **3 \- SBOM & SDLC** | Generate SBOMs per CRA original text (§3.1); validate completeness (§3.2); establish provenance signing (§3.3); implement SAST/DAST, threat modeling, release gate (§3.4); importer/distributor checklist (§3.5). | Platform Eng. | Month 2-4 |
...
| **6 \- OSS Governance** | Steward vs manufacturer determination (§5.1); upstream due-diligence (§5.1.6); publish SECURITY.md (§5.2). | OSS Program | Month 5-7 |
...
| **CRA Single Reporting Platform (SRP)** | The platform operated by ENISA for receiving Art. 14 notifications of actively exploited vulnerabilities and severe security incidents. |
...
| **OSS Steward** | A legal person providing sustained support for FOSS development without qualifying as a manufacturer under the commercial-activity test (CRA Art. 3(14), Recital 18). |
...
| **SBOM (Software Bill of Materials)** | A machine-readable inventory of software components in a product, covering at the very least the top-level dependencies (CRA Annex I Part II). |
| **Substantial Modification** | A modification to a product after market placement that affects the product's compliance with essential requirements or changes the intended purpose (CRA Art. 3(32)). |
...
| SBOM documentation | Part II, §6 | 3.1, 3.2 | Machine-readable SBOM covering at least top-level dependencies; NTIA field coverage |
...
| **Interlynk** | SBOM lifecycle management and CRA compliance tooling; references this checklist as a resource on their EU CRA solutions page at interlynk.io. | United States |  |
| **Lineaje** | Continuous software supply chain security and SBOM management platform; references this checklist as a CRA compliance resource on their Global Regulations page at lineaje.com. | United States |  |
...
| **Anchore**  | Container and software supply chain security platform; SBOM generation, vulnerability monitoring, and CRA compliance tooling.  | United States  |  |
...
●  BSI TR-03183 \- Technical Guideline for Cyber Resilience (German Federal Office for IT Security)
...
●  NTIA Minimum Elements for an SBOM \- [ntia.gov](https://www.ntia.gov/report/2021/minimum-elements-software-bill-materials-sbom)
...
●  Community comments Google Doc \- [docs.google.com/document (open for comments)](https://docs.google.com/document/d/1Wog28BZ9NQhY3tN9Wc2NDml2phBDuvYu9zkXSON5z5o/edit?usp=sharing)
