...
The register records organizations, public resources, forums, events, or other references that have indicated that they reference, use, evaluate, or rely on the OpenChain CRA Checklist in public materials, internal compliance work, customer guidance, tooling, advisory work, or related implementation activities.
...
| **Revenera (Flexera)** | SBOM management and CRA compliance tooling; publishes EU CRA checklist resources and publicly links to the OpenChain EU CRA Checklist from its SCA page. | United States | Public OpenChain reference: [Revenera Software Composition Analysis](https://www.revenera.com/software-composition-analysis)<br>Revenera EU CRA checklist: [PDF](https://resources.flexera.com/web/eloqua/pdf/Revenera-EU-CRA-Checklist.pdf)<br>SCA resources page: [Revenera resources](https://www.revenera.com/resources?category%5Bsoftware%20composition%20analysis%5D=software%20composition%20analysis) |
...
| **sbomify** | SBOM lifecycle management and CRA compliance resources; publicly references the OpenChain CRA Compliance resource page. | United Kingdom | Public reference: [https://sbomify.com/resources/](https://sbomify.com/resources/) |
